...
hi(0, "Aqua", { fg = "#90ce9f" })
hi(0, "AquaBold", { bold = true, fg = "#90ce9f" })
hi(0, "AquaItalic", { fg = "#90ce9f" })
hi(0, "AquaSign", { fg = "#90ce9f" })
...
hi(0, "BlinkCmpLabelMatch", { bold = true, fg = "#b4ce8d" })
hi(0, "Blue", { fg = "#8cc9c1" })
hi(0, "BlueBold", { bold = true, fg = "#8cc9c1" })
hi(0, "BlueItalic", { fg = "#8cc9c1" })
hi(0, "BlueSign", { fg = "#8cc9c1" })
...
hi(0, "BufferCurrent", { bg = "#1d242a", fg = "#e1d4b8" })
hi(0, "BufferCurrentADDED", { bg = "#1d242a", fg = "#b4ce8d" })
hi(0, "BufferCurrentCHANGED", { bg = "#1d242a", fg = "#8cc9c1" })
hi(0, "BufferCurrentDELETED", { bg = "#1d242a", fg = "#f58b8d" })
hi(0, "BufferCurrentERROR", { bg = "#1d242a", fg = "#f58b8d" })
hi(0, "BufferCurrentHINT", { bg = "#1d242a", fg = "#e9ca8c" })
hi(0, "BufferCurrentINFO", { bg = "#1d242a", fg = "#90ce9f" })
hi(0, "BufferCurrentIndex", { bg = "#1d242a", fg = "#e1d4b8" })
hi(0, "BufferCurrentMod", { bg = "#1d242a", fg = "#8cc9c1" })
hi(0, "BufferCurrentSign", { bg = "#1d242a", fg = "#b4ce8d" })
hi(0, "BufferCurrentTarget", { bg = "#1d242a", bold = true, fg = "#f58b8d" })
hi(0, "BufferCurrentWARN", { bg = "#1d242a", fg = "#f5a682" })
hi(0, "BufferInactive", { bg = "#13191d", fg = "#929f96" })
hi(0, "BufferInactiveADDED", { bg = "#13191d", fg = "#929f96" })
hi(0, "BufferInactiveCHANGED", { bg = "#13191d", fg = "#929f96" })
hi(0, "BufferInactiveDELETED", { bg = "#13191d", fg = "#929f96" })
hi(0, "BufferInactiveERROR", { bg = "#13191d", fg = "#929f96" })
hi(0, "BufferInactiveHINT", { bg = "#13191d", fg = "#929f96" })
hi(0, "BufferInactiveINFO", { bg = "#13191d", fg = "#929f96" })
hi(0, "BufferInactiveIndex", { bg = "#13191d", fg = "#929f96" })
hi(0, "BufferInactiveMod", { bg = "#13191d", fg = "#929f96" })
hi(0, "BufferInactiveSign", { bg = "#13191d", fg = "#879185" })
hi(0, "BufferInactiveTarget", { bg = "#13191d", bold = true, fg = "#e9ca8c" })
hi(0, "BufferInactiveWARN", { bg = "#13191d", fg = "#929f96" })
hi(0, "BufferLineIndicatorSelected", { link = "GreenSign" })
hi(0, "BufferTabpageFill", { bg = "#13191d", fg = "#2f363a" })
hi(0, "BufferTabpages", { bg = "#13191d", bold = true, fg = "#929f96" })
hi(0, "BufferVisible", { bg = "#13191d", fg = "#e1d4b8" })
hi(0, "BufferVisibleADDED", { bg = "#13191d", fg = "#b4ce8d" })
hi(0, "BufferVisibleCHANGED", { bg = "#13191d", fg = "#8cc9c1" })
hi(0, "BufferVisibleDELETED", { bg = "#13191d", fg = "#f58b8d" })
hi(0, "BufferVisibleERROR", { bg = "#13191d", fg = "#f58b8d" })
hi(0, "BufferVisibleHINT", { bg = "#13191d", fg = "#e9ca8c" })
hi(0, "BufferVisibleINFO", { bg = "#13191d", fg = "#90ce9f" })
hi(0, "BufferVisibleIndex", { bg = "#13191d", fg = "#e1d4b8" })
hi(0, "BufferVisibleMod", { bg = "#13191d", fg = "#8cc9c1" })
hi(0, "BufferVisibleSign", { bg = "#13191d", fg = "#b4ce8d" })
hi(0, "BufferVisibleTarget", { bg = "#13191d", bold = true, fg = "#e9ca8c" })
hi(0, "BufferVisibleWARN", { bg = "#13191d", fg = "#f5a682" })
hi(0, "BuffetActiveBuffer", { bg = "#1d242a", fg = "#e1d4b8" })
hi(0, "BuffetActiveBufferActiveBuffer", { link = "BuffetActiveBuffer" })
hi(0, "BuffetActiveBufferBuffer", { link = "BuffetActiveBuffer" })
hi(0, "BuffetActiveBufferCurrentBuffer", { bg = "#00e800", fg = "#a6a6a6" })
...
hi(0, "BuffetActiveBufferModCurrentBuffer", { bg = "#00e800", fg = "#a6a6a6" })
hi(0, "BuffetActiveBufferRightTrunc", { link = "BuffetActiveBuffer" })
hi(0, "BuffetActiveBufferTab", { bg = "#0000d2", fg = "#a6a6a6" })
hi(0, "BuffetBuffer", { bg = "#1d242a", fg = "#e1d4b8" })
hi(0, "BuffetBufferActiveBuffer", { link = "BuffetBuffer" })
hi(0, "BuffetBufferBuffer", { link = "BuffetBuffer" })
hi(0, "BuffetBufferCurrentBuffer", { bg = "#00e800", fg = "#a6a6a6" })
...
hi(0, "BuffetBufferModCurrentBuffer", { bg = "#00e800", fg = "#a6a6a6" })
hi(0, "BuffetBufferRightTrunc", { link = "BuffetBuffer" })
hi(0, "BuffetBufferTab", { bg = "#0000d2", fg = "#a6a6a6" })
hi(0, "BuffetCurrentBuffer", { bg = "#c0b397", bold = true, fg = "#394147" })
hi(0, "BuffetCurrentBufferActiveBuffer", { bg = "#878787", fg = "#8aff81" })
hi(0, "BuffetCurrentBufferBuffer", { bg = "#878787", fg = "#8aff81" })
hi(0, "BuffetCurrentBufferCurrentBuffer", { link = "BuffetCurrentBuffer" })
hi(0, "BuffetCurrentBufferEnd", { bg = "#878787", fg = "#8aff81" })
hi(0, "BuffetCurrentBufferModActiveBuffer", { bg = "#878787", fg = "#8aff81" })
hi(0, "BuffetCurrentBufferModBuffer", { bg = "#878787", fg = "#8aff81" })
hi(0, "BuffetCurrentBufferModCurrentBuffer", { link = "BuffetCurrentBuffer" })
hi(0, "BuffetCurrentBufferRightTrunc", { bg = "#878787", fg = "#8aff81" })
hi(0, "BuffetCurrentBufferTab", { bg = "#0000d2", fg = "#8aff81" })
...
hi(0, "BuffetLeftTruncCurrentBuffer", { bg = "#00e800", fg = "#a6a6a6" })
hi(0, "BuffetLeftTruncModActiveBuffer", { link = "BuffetLeftTrunc" })
hi(0, "BuffetLeftTruncModBuffer", { link = "BuffetLeftTrunc" })
hi(0, "BuffetLeftTruncModCurrentBuffer", { bg = "#00e800", fg = "#a6a6a6" })
...
hi(0, "BuffetModActiveBufferCurrentBuffer", { bg = "#00e800", fg = "#a6a6a6" })
...
hi(0, "BuffetModActiveBufferModCurrentBuffer", { bg = "#00e800", fg = "#a6a6a6" })
hi(0, "BuffetModActiveBufferRightTrunc", { link = "BuffetModActiveBuffer" })
hi(0, "BuffetModActiveBufferTab", { bg = "#0000d2", fg = "#a6a6a6" })
...
hi(0, "BuffetModBufferCurrentBuffer", { bg = "#00e800", fg = "#a6a6a6" })
...
hi(0, "BuffetModBufferModCurrentBuffer", { bg = "#00e800", fg = "#a6a6a6" })
hi(0, "BuffetModBufferRightTrunc", { link = "BuffetModBuffer" })
hi(0, "BuffetModBufferTab", { bg = "#0000d2", fg = "#a6a6a6" })
hi(0, "BuffetModCurrentBuffer", { link = "BuffetCurrentBuffer" })
hi(0, "BuffetModCurrentBufferActiveBuffer", { bg = "#878787", fg = "#8aff81" })
hi(0, "BuffetModCurrentBufferBuffer", { bg = "#878787", fg = "#8aff81" })
hi(0, "BuffetModCurrentBufferCurrentBuffer", { link = "BuffetModCurrentBuffer" })
hi(0, "BuffetModCurrentBufferEnd", { bg = "#878787", fg = "#8aff81" })
hi(0, "BuffetModCurrentBufferModActiveBuffer", { bg = "#878787", fg = "#8aff81" })
hi(0, "BuffetModCurrentBufferModBuffer", { bg = "#878787", fg = "#8aff81" })
hi(0, "BuffetModCurrentBufferModCurrentBuffer", { link = "BuffetModCurrentBuffer" })
hi(0, "BuffetModCurrentBufferRightTrunc", { bg = "#878787", fg = "#8aff81" })
hi(0, "BuffetModCurrentBufferTab", { bg = "#0000d2", fg = "#8aff81" })
hi(0, "BuffetRightTrunc", { link = "BuffetTrunc" })
hi(0, "BuffetRightTruncEnd", { link = "BuffetRightTrunc" })
hi(0, "BuffetRightTruncTab", { bg = "#0000d2", fg = "#a6a6a6" })
hi(0, "BuffetTab", { bg = "#1d242a", fg = "#e1d4b8" })
hi(0, "BuffetTabActiveBuffer", { bg = "#878787", fg = "#013aff" })
hi(0, "BuffetTabBuffer", { bg = "#878787", fg = "#013aff" })
hi(0, "BuffetTabCurrentBuffer", { bg = "#00e800", fg = "#013aff" })
hi(0, "BuffetTabEnd", { bg = "#878787", fg = "#013aff" })
hi(0, "BuffetTabLeftTrunc", { bg = "#878787", fg = "#013aff" })
hi(0, "BuffetTabModActiveBuffer", { bg = "#878787", fg = "#013aff" })
hi(0, "BuffetTabModBuffer", { bg = "#878787", fg = "#013aff" })
hi(0, "BuffetTabModCurrentBuffer", { bg = "#00e800", fg = "#013aff" })
hi(0, "BuffetTabTab", { link = "BuffetTab" })
hi(0, "BuffetTrunc", { bg = "#1d242a", fg = "#e1d4b8" })
hi(0, "Changed", { link = "Yellow" })
hi(0, "Character", { fg = "#b4ce8d" })
hi(0, "ClapBlines", { fg = "#e1d4b8" })
hi(0, "ClapBlinesLineNr", { link = "Grey" })
hi(0, "ClapCurrentSelection", { bg = "#242e33", bold = true })
hi(0, "ClapDisplay", { link = "Pmenu" })
hi(0, "ClapFile", { link = "Fg" })
hi(0, "ClapFuzzyMatches", { bold = true, fg = "#b4ce8d" })
...
hi(0, "ClapMatches1", { bold = true, fg = "#f58b8d" })
hi(0, "ClapMatches2", { bold = true, fg = "#f5a682" })
hi(0, "ClapMatches3", { bold = true, fg = "#e9ca8c" })
hi(0, "ClapMatches4", { bold = true, fg = "#90ce9f" })
hi(0, "ClapMatches5", { bold = true, fg = "#8cc9c1" })
hi(0, "ClapMatches6", { bold = true, fg = "#e4a6c4" })
hi(0, "ClapNoMatchesFound", { bold = true, fg = "#f58b8d" })
hi(0, "ClapPreview", { link = "Pmenu" })
hi(0, "ClapProviderAbout", { link = "ClapBlines" })
hi(0, "ClapProviderColon", { link = "ClapBlines" })
hi(0, "ClapProviderId", { bold = true, fg = "#e1d4b8" })
hi(0, "ClapSearchText", { link = "ClapFuzzyMatches" })
hi(0, "ClapSelected", { bold = true, fg = "#f58b8d" })
hi(0, "ClapSpinner", { bg = "#2d373c", bold = true, fg = "#f5a682" })
hi(0, "CleverFDefaultLabel", { link = "Search" })
hi(0, "CmpItemAbbr", { link = "Fg" })
hi(0, "CmpItemAbbrDefault", { fg = "#e1d4b8" })
hi(0, "CmpItemAbbrDeprecated", { link = "Grey" })
hi(0, "CmpItemAbbrDeprecatedDefault", { fg = "#929f96" })
hi(0, "CmpItemAbbrMatch", { bold = true, fg = "#b4ce8d" })
hi(0, "CmpItemAbbrMatchDefault", { fg = "#e1d4b8" })
hi(0, "CmpItemAbbrMatchFuzzy", { bold = true, fg = "#b4ce8d" })
hi(0, "CmpItemAbbrMatchFuzzyDefault", { fg = "#e1d4b8" })
...
hi(0, "CmpItemKindDefault", { fg = "#e9ca8c" })
...
hi(0, "CmpItemMenuDefault", { fg = "#e1d4b8" })
...
hi(0, "CocMarkdownHeader", { bold = true, fg = "#f5a682" })
hi(0, "CocMarkdownLink", { fg = "#b4ce8d", underline = true })
...
hi(0, "CocPumSearch", { bold = true, fg = "#b4ce8d" })
hi(0, "CocPumShortcut", { link = "Grey" })
hi(0, "CocPumVirtualText", { link = "Grey" })
hi(0, "CocSearch", { bold = true, fg = "#b4ce8d" })
...
hi(0, "CodeiumSuggestion", { ctermfg = 244, fg = "#8d8d8d" })
hi(0, "ColorColumn", { bg = "#242e33" })
hi(0, "Comment", { fg = "#929f96", italic = true })
hi(0, "Conceal", { fg = "#62706b" })
hi(0, "Conditional", { fg = "#f58b8d" })
hi(0, "Constant", { fg = "#90ce9f" })
hi(0, "CopilotSuggestion", { link = "Grey" })
hi(0, "CtrlPLinePre", { fg = "#535e64" })
hi(0, "CtrlPMatch", { bold = true, fg = "#b4ce8d" })
hi(0, "CtrlPMode1", { bg = "#374147", bold = true, fg = "#8cc9c1" })
hi(0, "CtrlPMode2", { bg = "#6ca8a0", bold = true, fg = "#394147" })
hi(0, "CtrlPNoEntries", { link = "Red" })
hi(0, "CtrlPPrtBase", { fg = "#535e64" })
hi(0, "CtrlPPrtCursor", { link = "Blue" })
hi(0, "CtrlPStats", { bg = "#374147", bold = true, fg = "#929f96" })
hi(0, "CurSearch", { link = "IncSearch" })
hi(0, "CurrentWord", { bold = true })
hi(0, "CurrentWordTwins", { link = "CurrentWord" })
hi(0, "Cursor", { bg = "#ba80c4", bold = true, fg = "#ffffff" })
hi(0, "CursorColumn", { bg = "#242e33" })
hi(0, "CursorInsert", { bg = "#9733a8", fg = "#080808" })
hi(0, "CursorLine", { bg = "#242e33" })
hi(0, "CursorLineNr", { fg = "#929f96" })
hi(0, "CursorWord0", { link = "CurrentWord" })
hi(0, "CursorWord1", { link = "CurrentWord" })
hi(0, "DapUIBreakpointsCurrentLine", { bold = true, fg = "#8cc9c1" })
...
hi(0, "DapUIModifiedValue", { bold = true, fg = "#8cc9c1" })
hi(0, "DapUIPlayPause", { bg = "#2d373c", fg = "#b4ce8d" })
hi(0, "DapUIRestart", { bg = "#2d373c", fg = "#b4ce8d" })
hi(0, "DapUIScope", { link = "Blue" })
hi(0, "DapUISource", { link = "Purple" })
hi(0, "DapUIStepBack", { bg = "#2d373c", fg = "#8cc9c1" })
hi(0, "DapUIStepInto", { bg = "#2d373c", fg = "#8cc9c1" })
hi(0, "DapUIStepOut", { bg = "#2d373c", fg = "#8cc9c1" })
hi(0, "DapUIStepOver", { bg = "#2d373c", fg = "#8cc9c1" })
hi(0, "DapUIStop", { bg = "#2d373c", fg = "#f58b8d" })
hi(0, "DapUIStoppedThread", { link = "Blue" })
hi(0, "DapUIThread", { link = "Green" })
hi(0, "DapUIType", { link = "Purple" })
hi(0, "DapUIUnavailable", { bg = "#2d373c", fg = "#929f96" })
...
hi(0, "Debug", { fg = "#f5a682" })
hi(0, "Define", { fg = "#e4a6c4" })
hi(0, "Delimiter", { fg = "#e1d4b8" })
hi(0, "DiagnosticBorder", { link = "Orange" })
hi(0, "DiagnosticError", { fg = "#f58b8d" })
...
hi(0, "DiagnosticHint", { fg = "#b4ce8d" })
hi(0, "DiagnosticInfo", { fg = "#8cc9c1" })
hi(0, "DiagnosticOk", { ctermfg = 10, fg = "#cbffd4" })
...
hi(0, "DiagnosticUnderlineError", { fg = "#f58b8d", sp = "#e67e80", undercurl = true })
hi(0, "DiagnosticUnderlineHint", { fg = "#b4ce8d", sp = "#a7c080", undercurl = true })
hi(0, "DiagnosticUnderlineInfo", { fg = "#8cc9c1", sp = "#7fbbb3", undercurl = true })
hi(0, "DiagnosticUnderlineWarn", { fg = "#e9ca8c", sp = "#dbbc7f", undercurl = true })
hi(0, "DiagnosticUnnecessary", { fg = "#929f96" })
...
hi(0, "DiagnosticWarn", { fg = "#e9ca8c" })
hi(0, "DiffAdd", { bg = "#323f37" })
hi(0, "DiffChange", { bg = "#2a404c" })
hi(0, "DiffDelete", { bg = "#403034" })
hi(0, "DiffText", { bg = "#6ca8a0", fg = "#394147" })
hi(0, "Directory", { fg = "#b4ce8d" })
...
hi(0, "EndOfBuffer", { fg = "#5b646a" })
hi(0, "Error", { fg = "#f58b8d" })
hi(0, "ErrorFloat", { fg = "#f58b8d" })
hi(0, "ErrorMsg", { bold = true, fg = "#f58b8d", underline = true })
hi(0, "ErrorText", { sp = "#e67e80", undercurl = true })
hi(0, "Exception", { fg = "#f58b8d" })
hi(0, "FSPrefix", { bg = "#1d242a", bold = true, fg = "#e1d4b8" })
hi(0, "FSSuffix", { fg = "#929f96" })
...
hi(0, "Fg", { fg = "#e1d4b8" })
hi(0, "FlashBackdrop", { fg = "#929f96" })
hi(0, "FlashLabel", { bold = true, fg = "#e4a6c4", italic = true })
hi(0, "Float", { fg = "#e4a6c4" })
hi(0, "FloatBorder", { bg = "#2d373c", fg = "#929f96" })
hi(0, "FloatShadow", { bg = "#3e4147", blend = 80, ctermbg = 0 })
hi(0, "FloatShadowThrough", { bg = "#3e4147", blend = 100, ctermbg = 0 })
hi(0, "FloatTitle", { bg = "#2d373c", bold = true, fg = "#929f96" })
hi(0, "FloatermBorder", { link = "Grey" })
hi(0, "FocusedSymbol", { link = "NormalFloat" })
hi(0, "FoldColumn", { fg = "#62706b" })
hi(0, "Folded", { bg = "#242e33", fg = "#929f96" })
hi(0, "Function", { fg = "#b4ce8d" })
...
hi(0, "GitSignsStagedAdd", { fg = "#65886c" })
hi(0, "GitSignsStagedAddCul", { fg = "#65886c" })
hi(0, "GitSignsStagedAddLn", { bg = "#004219", fg = "#848589" })
hi(0, "GitSignsStagedAddNr", { fg = "#65886c" })
hi(0, "GitSignsStagedChange", { fg = "#538988" })
hi(0, "GitSignsStagedChangeCul", { fg = "#538988" })
hi(0, "GitSignsStagedChangeLn", { bg = "#3e4147", fg = "#848589" })
hi(0, "GitSignsStagedChangeNr", { fg = "#538988" })
hi(0, "GitSignsStagedChangedelete", { fg = "#538988" })
hi(0, "GitSignsStagedChangedeleteCul", { fg = "#538988" })
hi(0, "GitSignsStagedChangedeleteLn", { bg = "#3e4147", fg = "#848589" })
hi(0, "GitSignsStagedChangedeleteNr", { fg = "#538988" })
hi(0, "GitSignsStagedDelete", { fg = "#8c6c68" })
hi(0, "GitSignsStagedDeleteCul", { fg = "#8c6c68" })
hi(0, "GitSignsStagedDeleteNr", { fg = "#8c6c68" })
hi(0, "GitSignsStagedTopdelete", { fg = "#8c6c68" })
hi(0, "GitSignsStagedTopdeleteCul", { fg = "#8c6c68" })
hi(0, "GitSignsStagedTopdeleteLn", { bg = "#403034" })
hi(0, "GitSignsStagedTopdeleteNr", { fg = "#8c6c68" })
hi(0, "GitSignsStagedUntracked", { fg = "#65886c" })
hi(0, "GitSignsStagedUntrackedCul", { fg = "#65886c" })
hi(0, "GitSignsStagedUntrackedLn", { bg = "#004219", fg = "#848589" })
hi(0, "GitSignsStagedUntrackedNr", { fg = "#65886c" })
hi(0, "GlyphPalette1", { fg = "#f58b8d" })
hi(0, "GlyphPalette2", { fg = "#b4ce8d" })
hi(0, "GlyphPalette3", { fg = "#e9ca8c" })
hi(0, "GlyphPalette4", { fg = "#8cc9c1" })
hi(0, "GlyphPalette6", { fg = "#b4ce8d" })
hi(0, "GlyphPalette7", { fg = "#e1d4b8" })
hi(0, "GlyphPalette9", { fg = "#f58b8d" })
hi(0, "Green", { fg = "#b4ce8d" })
hi(0, "GreenBold", { bold = true, fg = "#b4ce8d" })
hi(0, "GreenItalic", { fg = "#b4ce8d" })
hi(0, "GreenSign", { fg = "#b4ce8d" })
hi(0, "Grey", { fg = "#929f96" })
hi(0, "HighlightedyankRegion", { link = "Visual" })
hi(0, "HintFloat", { fg = "#b4ce8d" })
hi(0, "HintText", { sp = "#a7c080", undercurl = true })
hi(0, "HopNextKey", { bold = true, fg = "#f5a682" })
hi(0, "HopNextKey1", { bold = true, fg = "#b4ce8d" })
hi(0, "HopNextKey2", { link = "Green" })
hi(0, "HopUnmatched", { link = "Grey" })
hi(0, "HoverBorder", { link = "Green" })
hi(0, "IblIndent", { fg = "#5b646a", nocombine = true })
hi(0, "IblScope", { fg = "#929f96", nocombine = true })
hi(0, "Identifier", { fg = "#8cc9c1" })
hi(0, "Ignore", { fg = "#929f96" })
...
hi(0, "IncSearch", { bg = "#d16b6e", fg = "#394147" })
hi(0, "InclineNormalNC", { bg = "#2d373c", fg = "#929f96" })
hi(0, "Include", { fg = "#e4a6c4" })
...
hi(0, "InfoFloat", { fg = "#8cc9c1" })
hi(0, "InfoText", { sp = "#7fbbb3", undercurl = true })
hi(0, "InlayHints", { link = "LineNr" })
hi(0, "Keyword", { fg = "#f58b8d" })
hi(0, "Label", { fg = "#f5a682" })
hi(0, "LeapBackdrop", { fg = "#929f96" })
hi(0, "LeapLabel", { bold = true, fg = "#e4a6c4" })
hi(0, "LeapMatch", { bg = "#c287a3", bold = true, fg = "#e1d4b8" })
hi(0, "LightspeedGreyWash", { link = "Grey" })
hi(0, "LightspeedLabel", { bold = true, fg = "#f58b8d", underline = true })
hi(0, "LightspeedLabelDistant", { bold = true, fg = "#8cc9c1", underline = true })
hi(0, "LightspeedMaskedChar", { link = "Purple" })
hi(0, "LightspeedPendingOpArea", { bg = "#94ad6e", fg = "#394147" })
hi(0, "LightspeedShortcut", { bg = "#d16b6e", bold = true, fg = "#394147" })
hi(0, "LightspeedUnlabeledMatch", { bold = true, fg = "#e1d4b8" })
hi(0, "LineNr", { fg = "#62706b" })
hi(0, "LineNrAbove", { fg = "#62706b" })
hi(0, "LineNrBelow", { fg = "#62706b" })
...
hi(0, "Macro", { fg = "#90ce9f" })
hi(0, "MasonHeader", { bg = "#94ad6e", bold = true, fg = "#394147" })
hi(0, "MasonHeaderSecondary", { bg = "#d28563", bold = true, fg = "#394147" })
hi(0, "MasonHighlight", { link = "Green" })
hi(0, "MasonHighlightBlock", { bg = "#70ad80", fg = "#394147" })
hi(0, "MasonHighlightBlockBold", { bg = "#70ad80", bold = true, fg = "#394147" })
hi(0, "MasonHighlightBlockBoldSecondary", { bg = "#c7a96c", bold = true, fg = "#394147" })
hi(0, "MasonHighlightBlockSecondary", { bg = "#c7a96c", fg = "#394147" })
hi(0, "MasonHighlightSecondary", { link = "Yellow" })
hi(0, "MasonMuted", { fg = "#879185" })
hi(0, "MasonMutedBlock", { bg = "#687266", fg = "#394147" })
hi(0, "MatchParen", { bg = "#3e474d" })
...
hi(0, "MiniFilesFile", { fg = "#e1d4b8" })
hi(0, "MiniFilesNormal", { link = "NormalFloat" })
hi(0, "MiniFilesTitle", { link = "FloatTitle" })
hi(0, "MiniFilesTitleFocused", { bg = "#2d373c", bold = true, fg = "#b4ce8d" })
hi(0, "MiniHipatternsFixme", { bg = "#d16b6e", bold = true, fg = "#394147" })
hi(0, "MiniHipatternsHack", { bg = "#c7a96c", bold = true, fg = "#394147" })
hi(0, "MiniHipatternsNote", { bg = "#6ca8a0", bold = true, fg = "#394147" })
hi(0, "MiniHipatternsTodo", { bg = "#94ad6e", bold = true, fg = "#394147" })
hi(0, "MiniIconsAzure", { fg = "#8cc9c1" })
hi(0, "MiniIconsBlue", { fg = "#8cc9c1" })
hi(0, "MiniIconsCyan", { fg = "#90ce9f" })
hi(0, "MiniIconsGreen", { fg = "#b4ce8d" })
hi(0, "MiniIconsGrey", { fg = "#aab7ad" })
hi(0, "MiniIconsOrange", { fg = "#f5a682" })
hi(0, "MiniIconsPurple", { fg = "#e4a6c4" })
hi(0, "MiniIconsRed", { fg = "#f58b8d" })
hi(0, "MiniIconsYellow", { fg = "#e9ca8c" })
...
hi(0, "MiniJump2dSpot", { bold = true, fg = "#f5a682", nocombine = true })
hi(0, "MiniJump2dSpotAhead", { fg = "#90ce9f", nocombine = true })
hi(0, "MiniJump2dSpotUnique", { bold = true, fg = "#e9ca8c", nocombine = true })
...
hi(0, "MiniPickPrompt", { bg = "#2d373c", fg = "#8cc9c1" })
...
hi(0, "MiniStatuslineDevinfo", { bg = "#242e33", fg = "#aab7ad" })
hi(0, "MiniStatuslineFileinfo", { link = "MiniStatuslineDevinfo" })
hi(0, "MiniStatuslineFilename", { bg = "#242e33", fg = "#929f96" })
hi(0, "MiniStatuslineInactive", { link = "Grey" })
hi(0, "MiniStatuslineModeCommand", { bg = "#70ad80", bold = true, fg = "#394147" })
hi(0, "MiniStatuslineModeInsert", { bg = "#c0b397", bold = true, fg = "#394147" })
hi(0, "MiniStatuslineModeNormal", { bg = "#94ad6e", bold = true, fg = "#394147" })
hi(0, "MiniStatuslineModeOther", { bg = "#c287a3", bold = true, fg = "#394147" })
hi(0, "MiniStatuslineModeReplace", { bg = "#d28563", bold = true, fg = "#394147" })
hi(0, "MiniStatuslineModeVisual", { bg = "#d16b6e", bold = true, fg = "#394147" })
hi(0, "MiniSurround", { link = "IncSearch" })
hi(0, "MiniTablineCurrent", { bg = "#3e474d", fg = "#e1d4b8" })
hi(0, "MiniTablineFill", { link = "TabLineFill" })
hi(0, "MiniTablineHidden", { bg = "#2d373c", fg = "#929f96" })
hi(0, "MiniTablineModifiedCurrent", { bg = "#3e474d", fg = "#8cc9c1" })
hi(0, "MiniTablineModifiedHidden", { bg = "#2d373c", fg = "#929f96" })
hi(0, "MiniTablineModifiedVisible", { bg = "#2d373c", fg = "#8cc9c1" })
hi(0, "MiniTablineTabpagesection", { bg = "#94ad6e", bold = true, fg = "#394147" })
hi(0, "MiniTablineVisible", { bg = "#2d373c", fg = "#e1d4b8" })
hi(0, "MiniTestEmphasis", { bold = true })
hi(0, "MiniTestFail", { bold = true, fg = "#f58b8d" })
hi(0, "MiniTestPass", { bold = true, fg = "#b4ce8d" })
hi(0, "MiniTrailspace", { bg = "#d16b6e" })
hi(0, "ModeMsg", { bold = true, fg = "#e1d4b8" })
hi(0, "MoreMsg", { bold = true, fg = "#e9ca8c" })
...
hi(0, "NavicIconsArray", { fg = "#f5a682" })
hi(0, "NavicIconsBoolean", { fg = "#f5a682" })
hi(0, "NavicIconsClass", { fg = "#f5a682" })
hi(0, "NavicIconsConstant", { fg = "#e4a6c4" })
hi(0, "NavicIconsConstructor", { fg = "#f5a682" })
hi(0, "NavicIconsEnum", { fg = "#f5a682" })
hi(0, "NavicIconsEnumMember", { fg = "#b4ce8d" })
hi(0, "NavicIconsEvent", { fg = "#f5a682" })
hi(0, "NavicIconsField", { fg = "#b4ce8d" })
hi(0, "NavicIconsFile", { fg = "#e1d4b8" })
hi(0, "NavicIconsFunction", { fg = "#8cc9c1" })
hi(0, "NavicIconsInterface", { fg = "#f5a682" })
hi(0, "NavicIconsKey", { fg = "#e4a6c4" })
hi(0, "NavicIconsKeyword", { fg = "#e4a6c4" })
hi(0, "NavicIconsMethod", { fg = "#8cc9c1" })
hi(0, "NavicIconsModule", { fg = "#e9ca8c" })
hi(0, "NavicIconsNamespace", { fg = "#e1d4b8" })
hi(0, "NavicIconsNull", { fg = "#f5a682" })
hi(0, "NavicIconsNumber", { fg = "#f5a682" })
hi(0, "NavicIconsObject", { fg = "#f5a682" })
hi(0, "NavicIconsOperator", { fg = "#e1d4b8" })
hi(0, "NavicIconsPackage", { fg = "#e1d4b8" })
hi(0, "NavicIconsProperty", { fg = "#b4ce8d" })
hi(0, "NavicIconsString", { fg = "#b4ce8d" })
hi(0, "NavicIconsStruct", { fg = "#f5a682" })
hi(0, "NavicIconsTypeParameter", { fg = "#b4ce8d" })
hi(0, "NavicIconsVariable", { fg = "#e4a6c4" })
hi(0, "NavicSeparator", { fg = "#e1d4b8" })
hi(0, "NavicText", { fg = "#e1d4b8" })
hi(0, "NeoTreeDimText", { link = "Grey" })
hi(0, "NeoTreeDirectoryIcon", { link = "Orange" })
hi(0, "NeoTreeEndOfBuffer", { bg = "#13191d", fg = "#2f363a" })
...
hi(0, "NeoTreeNormal", { bg = "#13191d", fg = "#e1d4b8" })
hi(0, "NeoTreeNormalNC", { link = "NeoTreeNormal" })
hi(0, "NeoTreeRootName", { link = "Title" })
hi(0, "NeoTreeSignColumn", { link = "NeoTreeNormal" })
hi(0, "NeoTreeVertSplit", { bg = "#1d242a", fg = "#394147" })
hi(0, "NeogitActiveItem", { bg = "#60bbba", bold = true, fg = "#202227" })
hi(0, "NeogitBranch", { link = "Green" })
hi(0, "NeogitBranchHead", { bold = true, fg = "#eef0f8", underline = true })
...
hi(0, "NeogitChangeUnmerged", { bold = true, fg = "#c8cad0", italic = true })
...
hi(0, "NeogitDiffAddCursor", { bg = "#06070b", fg = "#cbffd4" })
hi(0, "NeogitDiffAddHighlight", { link = "DiffAdd" })
hi(0, "NeogitDiffAdditions", { fg = "#a1d8aa" })
hi(0, "NeogitDiffContext", { bg = "#06070b" })
hi(0, "NeogitDiffContextCursor", { bg = "#06070b" })
hi(0, "NeogitDiffContextHighlight", { link = "CursorLine" })
hi(0, "NeogitDiffDelete", { link = "DiffDelete" })
hi(0, "NeogitDiffDeleteCursor", { bg = "#06070b", fg = "#ffffff" })
hi(0, "NeogitDiffDeleteHighlight", { link = "DiffDelete" })
hi(0, "NeogitDiffDeletions", { fg = "#d1d4d9" })
hi(0, "NeogitDiffHeader", { bg = "#1e2023", bold = true, fg = "#eef0f8" })
hi(0, "NeogitDiffHeaderHighlight", { bg = "#1e2023", bold = true, fg = "#baffff" })
hi(0, "NeogitFilePath", { link = "Aqua" })
hi(0, "NeogitFloatHeader", { bg = "#020306", bold = true })
hi(0, "NeogitFloatHeaderHighlight", { bg = "#121419", bold = true, fg = "#eef0f8" })
hi(0, "NeogitFold", { link = "FoldColumn" })
hi(0, "NeogitGraphAuthor", { fg = "#baffff" })
hi(0, "NeogitGraphBlue", { fg = "#eef0f8" })
hi(0, "NeogitGraphBoldBlue", { bold = true, fg = "#eef0f8" })
hi(0, "NeogitGraphBoldCyan", { bold = true, fg = "#eef0f8" })
hi(0, "NeogitGraphBoldGray", { bold = true, fg = "#7f8083" })
hi(0, "NeogitGraphBoldGreen", { bold = true, fg = "#cbffd4" })
hi(0, "NeogitGraphBoldOrange", { bold = true, fg = "#baffff" })
hi(0, "NeogitGraphBoldPurple", { bold = true, fg = "#eef0f8" })
hi(0, "NeogitGraphBoldRed", { bold = true, fg = "#ffffff" })
hi(0, "NeogitGraphBoldWhite", { bold = true, fg = "#ffffff" })
hi(0, "NeogitGraphBoldYellow", { bold = true, fg = "#eef0f8" })
hi(0, "NeogitGraphCyan", { fg = "#eef0f8" })
hi(0, "NeogitGraphGray", { fg = "#7f8083" })
hi(0, "NeogitGraphGreen", { fg = "#cbffd4" })
hi(0, "NeogitGraphOrange", { fg = "#baffff" })
hi(0, "NeogitGraphPurple", { fg = "#eef0f8" })
hi(0, "NeogitGraphRed", { fg = "#ffffff" })
hi(0, "NeogitGraphWhite", { fg = "#ffffff" })
hi(0, "NeogitGraphYellow", { fg = "#eef0f8" })
hi(0, "NeogitHunkHeader", { link = "TabLineFill" })
hi(0, "NeogitHunkHeaderCursor", { bg = "#d2d3da", bold = true, fg = "#202227" })
hi(0, "NeogitHunkHeaderHighlight", { link = "TabLine" })
hi(0, "NeogitHunkMergeHeader", { bg = "#616164", bold = true, fg = "#2f3136" })
hi(0, "NeogitHunkMergeHeaderCursor", { bg = "#a5a6ad", bold = true, fg = "#202227" })
hi(0, "NeogitHunkMergeHeaderHighlight", { bg = "#a5a6ad", bold = true, fg = "#202227" })
...
hi(0, "NeogitObjectId", { bold = true, fg = "#b4ce8d", italic = true })
hi(0, "NeogitPopupActionKey", { fg = "#eef0f8" })
hi(0, "NeogitPopupBold", { bold = true })
hi(0, "NeogitPopupConfigKey", { fg = "#eef0f8" })
hi(0, "NeogitPopupOptionKey", { fg = "#eef0f8" })
hi(0, "NeogitPopupSwitchKey", { fg = "#eef0f8" })
hi(0, "NeogitRecentcommits", { link = "AquaBold" })
hi(0, "NeogitRemote", { link = "Purple" })
hi(0, "NeogitSectionHeader", { bold = true, fg = "#c6c7ce" })
hi(0, "NeogitStashes", { link = "BlueBold" })
hi(0, "NeogitTagDistance", { fg = "#eef0f8" })
hi(0, "NeogitTagName", { fg = "#eef0f8" })
hi(0, "NeogitUnmergedInto", { link = "PurpleItalic" })
hi(0, "NeogitUnpulledFrom", { bold = true, fg = "#c6c7ce" })
...
hi(0, "NeotestBorder", { fg = "#8cc9c1" })
hi(0, "NeotestDir", { link = "Directory" })
hi(0, "NeotestExpandMarker", { fg = "#62706b" })
hi(0, "NeotestFailed", { link = "RedSign" })
hi(0, "NeotestFile", { link = "Aqua" })
hi(0, "NeotestFocused", { fg = "#e9ca8c" })
...
hi(0, "NeotestWinSelect", { fg = "#8cc9c1" })
hi(0, "NoiceCompletionItemKindClass", { fg = "#f5a682" })
hi(0, "NoiceCompletionItemKindConstant", { fg = "#f58b8d" })
hi(0, "NoiceCompletionItemKindConstructor", { fg = "#8cc9c1" })
hi(0, "NoiceCompletionItemKindDefault", { fg = "#929f96" })
hi(0, "NoiceCompletionItemKindEnum", { fg = "#f5a682" })
hi(0, "NoiceCompletionItemKindEnumMember", { fg = "#b4ce8d" })
hi(0, "NoiceCompletionItemKindEvent", { fg = "#f5a682" })
hi(0, "NoiceCompletionItemKindField", { fg = "#b4ce8d" })
hi(0, "NoiceCompletionItemKindFunction", { fg = "#8cc9c1" })
hi(0, "NoiceCompletionItemKindInterface", { fg = "#f5a682" })
hi(0, "NoiceCompletionItemKindKeyword", { fg = "#90ce9f" })
hi(0, "NoiceCompletionItemKindMethod", { fg = "#8cc9c1" })
hi(0, "NoiceCompletionItemKindModule", { fg = "#e9ca8c" })
hi(0, "NoiceCompletionItemKindOperator", { fg = "#b4ce8d" })
hi(0, "NoiceCompletionItemKindProperty", { fg = "#b4ce8d" })
hi(0, "NoiceCompletionItemKindReference", { fg = "#f58b8d" })
hi(0, "NoiceCompletionItemKindSnippet", { fg = "#929f96" })
hi(0, "NoiceCompletionItemKindStruct", { fg = "#f5a682" })
hi(0, "NoiceCompletionItemKindTypeParameter", { fg = "#b4ce8d" })
hi(0, "NoiceCompletionItemKindUnit", { fg = "#f5a682" })
hi(0, "NoiceCompletionItemKindValue", { fg = "#f58b8d" })
hi(0, "NoiceCompletionItemKindVariable", { fg = "#f58b8d" })
hi(0, "NonText", { fg = "#5b646a" })
hi(0, "Normal", { bg = "#1d242a", fg = "#e1d4b8" })
hi(0, "NormalFloat", { bg = "#2d373c", fg = "#e1d4b8" })
hi(0, "NormalNC", { bg = "#1d242a", fg = "#e1d4b8" })
hi(0, "NotifyBackground", { bg = "#1d242a" })
...
hi(0, "Number", { fg = "#e4a6c4" })
hi(0, "NvimInternalError", { bg = "#df0000", ctermbg = 9, ctermfg = 9, fg = "#ff4636" })
hi(0, "NvimSeparator", { bg = "#1d242a", fg = "#a289d4" })
hi(0, "NvimTreeCursorLine", { bg = "#1d242a" })
hi(0, "NvimTreeEmptyFolderName", { link = "Green" })
hi(0, "NvimTreeEndOfBuffer", { bg = "#13191d", fg = "#2f363a" })
...
hi(0, "NvimTreeNormal", { bg = "#13191d", fg = "#e1d4b8" })
...
hi(0, "NvimTreeVertSplit", { bg = "#1d242a", fg = "#394147" })
hi(0, "NvimTreeWindowPicker", { bg = "#2f80b4", bold = true, ctermbg = 4, ctermfg = 15, fg = "#fbfbfb" })
hi(0, "OctoBlue", { link = "Blue" })
hi(0, "OctoBlueFloat", { bg = "#2d373c", fg = "#8cc9c1" })
hi(0, "OctoBubbleBlue", { bg = "#6ca8a0", fg = "#394147" })
...
hi(0, "OctoBubbleGreen", { bg = "#94ad6e", fg = "#394147" })
hi(0, "OctoBubbleGrey", { bg = "#738077", fg = "#394147" })
hi(0, "OctoBubblePurple", { bg = "#c287a3", fg = "#394147" })
hi(0, "OctoBubbleRed", { bg = "#d16b6e", fg = "#394147" })
hi(0, "OctoBubbleYellow", { bg = "#c7a96c", fg = "#394147" })
hi(0, "OctoGreen", { link = "Green" })
hi(0, "OctoGreenFloat", { bg = "#2d373c", fg = "#b4ce8d" })
hi(0, "OctoGrey", { link = "Grey" })
hi(0, "OctoGreyFloat", { bg = "#2d373c", fg = "#929f96" })
hi(0, "OctoPurple", { link = "Purple" })
hi(0, "OctoPurpleFloat", { bg = "#2d373c", fg = "#e4a6c4" })
hi(0, "OctoRed", { link = "Red" })
hi(0, "OctoRedFloat", { bg = "#2d373c", fg = "#f58b8d" })
hi(0, "OctoViewer", { bg = "#6ca8a0", fg = "#394147" })
hi(0, "OctoYellow", { link = "Yellow" })
hi(0, "OctoYellowFloat", { bg = "#2d373c", fg = "#e9ca8c" })
hi(0, "Operator", { fg = "#f5a682" })
hi(0, "Orange", { fg = "#f5a682" })
hi(0, "OrangeBold", { bold = true, fg = "#f5a682" })
hi(0, "OrangeItalic", { fg = "#f5a682" })
hi(0, "OrangeSign", { fg = "#f5a682" })
hi(0, "Pmenu", { bg = "#2d373c", fg = "#e1d4b8" })
hi(0, "PmenuSbar", { bg = "#2d373c" })
hi(0, "PmenuSel", { bg = "#94ad6e", fg = "#394147" })
hi(0, "PmenuThumb", { bg = "#687266" })
hi(0, "PreCondit", { fg = "#e4a6c4" })
hi(0, "PreProc", { fg = "#e4a6c4" })
hi(0, "Purple", { fg = "#e4a6c4" })
hi(0, "PurpleBold", { bold = true, fg = "#e4a6c4" })
hi(0, "PurpleItalic", { fg = "#e4a6c4" })
hi(0, "PurpleSign", { fg = "#e4a6c4" })
hi(0, "Question", { fg = "#e9ca8c" })
hi(0, "QuickFixLine", { bold = true, fg = "#e4a6c4" })
hi(0, "QuickScopePrimary", { fg = "#90ce9f", underline = true })
hi(0, "QuickScopeSecondary", { fg = "#8cc9c1", underline = true })
...
hi(0, "Red", { fg = "#f58b8d" })
hi(0, "RedBold", { bold = true, fg = "#f58b8d" })
hi(0, "RedItalic", { fg = "#f58b8d" })
hi(0, "RedSign", { fg = "#f58b8d" })
...
hi(0, "Repeat", { fg = "#f58b8d" })
hi(0, "SagaBorder", { link = "Blue" })
hi(0, "ScrollbarError", { fg = "#f58b8d" })
hi(0, "ScrollbarErrorHandle", { bg = "#242e33", fg = "#f58b8d" })
hi(0, "ScrollbarHandle", { bg = "#242e33" })
hi(0, "ScrollbarHint", { fg = "#8cc9c1" })
hi(0, "ScrollbarHintHandle", { bg = "#242e33", fg = "#8cc9c1" })
hi(0, "ScrollbarInfo", { fg = "#b4ce8d" })
hi(0, "ScrollbarInfoHandle", { bg = "#242e33", fg = "#b4ce8d" })
hi(0, "ScrollbarMisc", { fg = "#e4a6c4" })
hi(0, "ScrollbarMiscHandle", { bg = "#242e33", fg = "#e4a6c4" })
hi(0, "ScrollbarSearch", { fg = "#f5a682" })
hi(0, "ScrollbarSearchHandle", { bg = "#242e33", fg = "#f5a682" })
hi(0, "ScrollbarWarn", { fg = "#e9ca8c" })
hi(0, "ScrollbarWarnHandle", { bg = "#242e33", fg = "#e9ca8c" })
hi(0, "Search", { bg = "#94ad6e", fg = "#394147" })
hi(0, "SignColumn", { fg = "#e1d4b8" })
...
hi(0, "SmoothCursor", { fg = "#ffe585" })
hi(0, "SmoothCursorAqua", { fg = "#a9ffff" })
hi(0, "SmoothCursorBlue", { fg = "#013aff" })
hi(0, "SmoothCursorGreen", { fg = "#1e8d1a" })
hi(0, "SmoothCursorOrange", { fg = "#ffb95f" })
hi(0, "SmoothCursorPurple", { fg = "#8e1b8e" })
hi(0, "SmoothCursorRed", { fg = "#ff4636" })
hi(0, "SmoothCursorYellow", { fg = "#ffffff" })
hi(0, "Sneak", { link = "Search" })
hi(0, "SneakLabel", { link = "Search" })
hi(0, "SneakLabelMask", { bg = "#d28563", fg = "#f5a682" })
hi(0, "SneakScope", { link = "DiffText" })
hi(0, "Special", { fg = "#e9ca8c" })
hi(0, "SpecialChar", { fg = "#e9ca8c" })
hi(0, "SpecialComment", { fg = "#929f96", italic = true })
hi(0, "SpecialKey", { fg = "#e9ca8c" })
...
hi(0, "Statement", { fg = "#f58b8d" })
hi(0, "StatusLine", { bg = "#2d373c", fg = "#929f96" })
hi(0, "StatusLineNC", { bg = "#242e33", fg = "#929f96" })
hi(0, "StatusLineTerm", { bg = "#242e33", fg = "#929f96" })
hi(0, "StatusLineTermNC", { bg = "#1d242a", fg = "#929f96" })
hi(0, "StorageClass", { fg = "#f5a682" })
hi(0, "String", { fg = "#b4ce8d" })
hi(0, "Structure", { fg = "#f5a682" })
hi(0, "Substitute", { bg = "#c7a96c", fg = "#394147" })
...
hi(0, "TSDanger", { bg = "#d16b6e", bold = true, fg = "#394147" })
...
hi(0, "TSNone", { link = "Fg" })
hi(0, "TSNote", { bg = "#94ad6e", bold = true, fg = "#394147" })
...
hi(0, "TSURI", { fg = "#8cc9c1", underline = true })
hi(0, "TSUnderline", { underline = true })
hi(0, "TSVariable", { link = "Fg" })
hi(0, "TSVariableBuiltin", { link = "PurpleItalic" })
hi(0, "TSWarning", { bg = "#c7a96c", bold = true, fg = "#394147" })
hi(0, "TabLine", { bg = "#374147", fg = "#aab7ad" })
hi(0, "TabLineFill", { bg = "#242e33", fg = "#929f96" })
hi(0, "TabLineSel", { bg = "#94ad6e", fg = "#394147" })
hi(0, "Tag", { fg = "#f5a682" })
...
hi(0, "TelescopeMatching", { bold = true, fg = "#b4ce8d" })
...
hi(0, "Terminal", { bg = "#1d242a", fg = "#e1d4b8" })
hi(0, "Title", { bold = true, fg = "#f5a682" })
hi(0, "Todo", { bg = "#6ca8a0", bold = true, fg = "#394147" })
hi(0, "TodoBgFIX", { bg = "#d16b6e", bold = true, fg = "#394147" })
hi(0, "TodoBgHACK", { bg = "#c7a96c", bold = true, fg = "#394147" })
hi(0, "TodoBgNOTE", { bg = "#94ad6e", bold = true, fg = "#394147" })
hi(0, "TodoBgPERF", { bg = "#6ca8a0", bold = true, fg = "#394147" })
hi(0, "TodoBgTEST", { bg = "#6ca8a0", bold = true, fg = "#394147" })
hi(0, "TodoBgTODO", { bg = "#6ca8a0", bold = true, fg = "#394147" })
hi(0, "TodoBgWARN", { bg = "#c7a96c", bold = true, fg = "#394147" })
hi(0, "TodoFgFIX", { fg = "#f58b8d" })
hi(0, "TodoFgHACK", { fg = "#e9ca8c" })
hi(0, "TodoFgNOTE", { fg = "#b4ce8d" })
hi(0, "TodoFgPERF", { fg = "#8cc9c1" })
hi(0, "TodoFgTEST", { fg = "#8cc9c1" })
hi(0, "TodoFgTODO", { fg = "#8cc9c1" })
hi(0, "TodoFgWARN", { fg = "#e9ca8c" })
hi(0, "TodoSignFIX", { fg = "#f58b8d" })
hi(0, "TodoSignHACK", { fg = "#e9ca8c" })
hi(0, "TodoSignNOTE", { fg = "#b4ce8d" })
hi(0, "TodoSignPERF", { fg = "#8cc9c1" })
hi(0, "TodoSignTEST", { fg = "#8cc9c1" })
hi(0, "TodoSignTODO", { fg = "#8cc9c1" })
hi(0, "TodoSignWARN", { fg = "#e9ca8c" })
hi(0, "ToolbarButton", { bg = "#94ad6e", fg = "#394147" })
hi(0, "ToolbarLine", { bg = "#2d373c", fg = "#e1d4b8" })
hi(0, "TroubleCode", { link = "Grey" })
hi(0, "TroubleSource", { link = "Grey" })
hi(0, "TroubleText", { link = "Fg" })
hi(0, "Type", { fg = "#e9ca8c" })
hi(0, "Typedef", { fg = "#f58b8d" })
hi(0, "UfoFoldedFg", { fg = "#e1d4b8" })
...
hi(0, "Visual", { bg = "#422a37" })
hi(0, "VisualNOS", { bg = "#422a37" })
hi(0, "WarningFloat", { fg = "#e9ca8c" })
hi(0, "WarningMsg", { bold = true, fg = "#e9ca8c" })
hi(0, "WarningText", { sp = "#dbbc7f", undercurl = true })
hi(0, "WhichKey", { link = "Red" })
hi(0, "WhichKeyDesc", { link = "Blue" })
hi(0, "WhichKeyFloat", { bg = "#242e33" })
...
hi(0, "WhichKeyValue", { fg = "#e1d4b8" })
hi(0, "Whitespace", { fg = "#5b646a" })
hi(0, "WinBar", { bg = "#2d373c", bold = true, fg = "#929f96" })
hi(0, "WinBarNC", { bg = "#242e33", fg = "#929f96" })
...
hi(0, "Yellow", { fg = "#e9ca8c" })
hi(0, "YellowBold", { bold = true, fg = "#e9ca8c" })
hi(0, "YellowItalic", { fg = "#e9ca8c" })
hi(0, "YellowSign", { fg = "#e9ca8c" })
hi(0, "ZenBg", { bg = "#1a2127", fg = "#363e44" })
...
hi(0, "debugBreakpoint", { bg = "#d16b6e", fg = "#394147" })
hi(0, "debugPC", { bg = "#94ad6e", fg = "#394147" })
hi(0, "deniteInput", { bg = "#374147", bold = true, fg = "#b4ce8d" })
hi(0, "deniteMatchedChar", { bold = true, fg = "#b4ce8d" })
hi(0, "deniteMatchedRange", { bold = true, fg = "#b4ce8d", underline = true })
hi(0, "deniteSelectedLin", { link = "Green" })
hi(0, "deniteStatusLineNumber", { bg = "#374147", fg = "#e4a6c4" })
hi(0, "deniteStatusLinePath", { bg = "#374147", fg = "#e1d4b8" })
...
hi(0, "helpHeader", { bold = true, fg = "#f5a682" })
hi(0, "helpHeadline", { bold = true, fg = "#f58b8d" })
hi(0, "helpHyperTextEntry", { bold = true, fg = "#e9ca8c" })
hi(0, "helpHyperTextJump", { link = "Yellow" })
hi(0, "helpNote", { bold = true, fg = "#e4a6c4" })
hi(0, "helpSectionDelim", { link = "Grey" })
hi(0, "helpSpecial", { link = "Blue" })
hi(0, "helpURL", { fg = "#b4ce8d", underline = true })
...
hi(0, "htmlH1", { bold = true, fg = "#f58b8d" })
hi(0, "htmlH2", { bold = true, fg = "#f5a682" })
hi(0, "htmlH3", { bold = true, fg = "#e9ca8c" })
hi(0, "htmlH4", { bold = true, fg = "#b4ce8d" })
hi(0, "htmlH5", { bold = true, fg = "#8cc9c1" })
hi(0, "htmlH6", { bold = true, fg = "#e4a6c4" })
...
hi(0, "lualine_a_filename_command", { bg = "#1d242a", fg = "#929f96" })
hi(0, "lualine_a_filename_inactive", { bg = "#1d242a", fg = "#929f96" })
hi(0, "lualine_a_filename_insert", { bg = "#1d242a", fg = "#929f96" })
hi(0, "lualine_a_filename_normal", { bg = "#1d242a", fg = "#929f96" })
hi(0, "lualine_a_filename_replace", { bg = "#1d242a", fg = "#929f96" })
hi(0, "lualine_a_filename_terminal", { bg = "#1d242a", fg = "#929f96" })
hi(0, "lualine_a_filename_visual", { bg = "#1d242a", fg = "#929f96" })
hi(0, "lualine_a_inactive", { bg = "#1d242a", fg = "#929f96" })
hi(0, "lualine_a_insert", { bg = "#94ad6e", bold = true, fg = "#394147" })
hi(0, "lualine_a_normal", { bg = "#d16b6e", bold = true, fg = "#394147" })
hi(0, "lualine_a_replace", { bg = "#d16b6e", bold = true, fg = "#394147" })
hi(0, "lualine_a_visual", { bg = "#422a37", bold = true, fg = "#e1d4b8" })
hi(0, "lualine_b_filename", { bg = "#252d33", fg = "#e1d4b8" })
hi(0, "lualine_b_filename_command", { bg = "#252d33", fg = "#e1d4b8" })
hi(0, "lualine_b_filename_inactive", { bg = "#252d33", fg = "#e1d4b8" })
hi(0, "lualine_b_filename_insert", { bg = "#252d33", fg = "#e1d4b8" })
hi(0, "lualine_b_filename_normal", { bg = "#252d33", fg = "#e1d4b8" })
hi(0, "lualine_b_filename_replace", { bg = "#252d33", fg = "#e1d4b8" })
hi(0, "lualine_b_filename_terminal", { bg = "#252d33", fg = "#e1d4b8" })
hi(0, "lualine_b_filename_visual", { bg = "#252d33", fg = "#e1d4b8" })
hi(0, "lualine_b_inactive", { bg = "#1d242a", fg = "#929f96" })
hi(0, "lualine_b_normal", { bg = "#252d33", fg = "#e1d4b8" })
hi(0, "lualine_c_branch", { bg = "#8db66e", fg = "#394147" })
hi(0, "lualine_c_branch_command", { bg = "#8db66e", fg = "#394147" })
hi(0, "lualine_c_branch_inactive", { bg = "#8db66e", fg = "#394147" })
hi(0, "lualine_c_branch_insert", { bg = "#8db66e", fg = "#394147" })
hi(0, "lualine_c_branch_normal", { bg = "#8db66e", fg = "#394147" })
hi(0, "lualine_c_branch_replace", { bg = "#8db66e", fg = "#394147" })
hi(0, "lualine_c_branch_terminal", { bg = "#8db66e", fg = "#394147" })
hi(0, "lualine_c_branch_visual", { bg = "#8db66e", fg = "#394147" })
hi(0, "lualine_c_inactive", { bg = "#1d242a", fg = "#929f96" })
hi(0, "lualine_c_normal", { bg = "#1d242a", fg = "#929f96" })
hi(0, "lualine_transitional_lualine_a_normal_to_lualine_b_filename", { bg = "#252d33", fg = "#f58b8d" })
hi(0, "lualine_transitional_lualine_b_filename_to_lualine_c_branch", { bg = "#8db66e", fg = "#414a50" })
hi(0, "lualine_transitional_lualine_c_branch_to_lualine_c_normal", { bg = "#1d242a", fg = "#add78d" })
...
hi(0, "markdownH1", { bold = true, fg = "#f58b8d" })
hi(0, "markdownH2", { bold = true, fg = "#f5a682" })
hi(0, "markdownH3", { bold = true, fg = "#e9ca8c" })
hi(0, "markdownH4", { bold = true, fg = "#b4ce8d" })
hi(0, "markdownH5", { bold = true, fg = "#8cc9c1" })
hi(0, "markdownH6", { bold = true, fg = "#e4a6c4" })
...
hi(0, "markdownItalicDelimiter", { fg = "#929f96", italic = true })
...
hi(0, "plug1", { bold = true, fg = "#f5a682" })
...
hi(0, "plugNumber", { bold = true, fg = "#e9ca8c" })
